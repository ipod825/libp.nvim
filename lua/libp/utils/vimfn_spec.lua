...
describe("set_cwd", function()
    it("sets the cwd", function()
        assert.are.not_same(vim.fn.getcwd(), reflection.git_project_root())
        vimfn.set_cwd(reflection.git_project_root())
        assert.are.same(vim.fn.getcwd(), reflection.git_project_root())
    end)
end)
