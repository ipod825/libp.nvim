...
describe("insert", function()
    pending("Inserts node after tail", function()
    ...
    pending("Inserts node in between", function()
        local lst = DoubleLinkList.from_list({ 1, 2 })
        local first = lst.head
        local second = first.right
        lst:insert(first, 3)
...
describe("push_front", function()
    pending("Pushes to the front", function()
...
describe("push_back", function()
    pending("Pushes to the back", function()
        local lst = DoubleLinkList()
        lst:push_back(1)
        assert.are.same({ 1 }, lst:to_list())
        assert.are.same({ 1 }, lst:to_reverse_list())
...
describe("pop_back", function()
    ...
    pending("Pops from the back", function()
        local lst = DoubleLinkList.from_list({ 1, 2, 3 })
...
describe("remove", function()
    pending("Removes single", function()
        local lst = DoubleLinkList.from_list({ 1 })
        lst:remove(lst.head)
        assert.are.same({}, lst:to_list())
    end)
    pending("Removes middle", function()
        local lst = DoubleLinkList.from_list({ 1, 2, 3 })
        local middle = lst.head.right
        lst:remove(middle)
        assert.are.same({ 1, 3 }, lst:to_list())
    end)
    pending("Removes front", function()
        local lst = DoubleLinkList.from_list({ 1, 2, 3 })
        lst:remove(lst.head)
        assert.are.same({ 2, 3 }, lst:to_list())
    end)
    pending("Removes back", function()
        local lst = DoubleLinkList.from_list({ 1, 2, 3 })
        lst:remove(lst.tail)
        assert.are.same({ 1, 2 }, lst:to_list())
    end)
...
describe("splice", function()
    ...
    describe("different list", function()
        ...
        describe("two args", function()
            pending("Works when lst is empty", function()
                lst = DoubleLinkList()
            ...
            pending("Works when that is empty", function()
                that = DoubleLinkList()
